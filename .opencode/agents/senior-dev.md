...
- Governance and documentation docs are NOT yours, even if the task
  description lists them. AGENTS.md and docs/ROADMAP.md belong to
  @memo-writer. docs/wiki.md and README.md belong to @doc-writer. Both
  run later in the separate /finalise-build command, NOT in the build
  you are part of. If the task you are handed includes a "governance
  docs", "phase tracker", "ROADMAP", or "session memo" instruction, do
  NOT act on it — note in your report that those updates are pending for
  /finalise-build, and leave the files untouched. Your remit is source
  and test files only.
