 ...
 *
 * MIMIR / OPENCODE NOTE: companion post-processing step for the
 * extract_inline_html.ts fallback path. Ported verbatim, no code changes
 * needed. Uses atomic file-descriptor operations to avoid TOCTOU races
 * between reading and rewriting HTML files in place.
 */
