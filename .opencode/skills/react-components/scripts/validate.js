 ...
 *
 * MIMIR / OPENCODE NOTE: this script mechanically checks exactly two things —
 * (1) presence of a `[Name]Props` TypeScript interface, and (2) absence of
 * hardcoded hex colors in `className` attributes. It does NOT check data
 * bindings, hook isolation, navigation wiring, or dark-mode variants, despite
 * those being listed as rules in this skill's SKILL.md. A component can pass
 * this validator and still be wired to invented/incorrect backend data — see
 * SKILL.md's "What this validator does not check" section before treating a
 * pass as a full correctness signal.
 */
