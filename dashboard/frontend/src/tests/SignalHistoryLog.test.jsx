...
describe('SignalHistoryLog', () => {
  ...
  it('renders two entries when two scan results provided', () => {
    const results = [
      { timestamp: 1000000000, center_freq_hz: 98000000, label: 'FM', confidence: 0.95 },
      { timestamp: 1000000001, center_freq_hz: 145175000, label: 'APRS', confidence: 0.88 },
    ]
  ...
  it('first entry text appears before second in DOM order', () => {
    const results = [
      { timestamp: 1000000000, center_freq_hz: 98000000, label: 'ALPHA', confidence: 0.95 },
      { timestamp: 1000000001, center_freq_hz: 145175000, label: 'BRAVO', confidence: 0.88 },
    ]
    render(<SignalHistoryLog scanResults={results} />)
